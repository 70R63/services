									...
									<div class="card-body">
										...
										<div class="profile-tab tab-menu-heading">
											<nav class="nav main-nav-line p-3 tabs-menu profile-nav-line bg-gray-100">
												<a class="nav-link  active" data-toggle="tab" href="#about">Acerca de</a>
												<a class="nav-link" data-toggle="tab" href="#edit">Editar Perfil</a>
												<a class="nav-link" data-toggle="tab" href="#settings">Configuración de usuario</a>
											</nav>
										</div>
									</div>
								</div>
										...
										<div class="main-content-body tab-pane p-4 border-top-0" id="edit">
											<div class="card-body border">
												...
												<form class="form-horizontal">
													<div class="mb-4 main-content-label">Nombre</div>
