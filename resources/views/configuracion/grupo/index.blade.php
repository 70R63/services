	...
	<div class="modal-dialog" role="document">
		...
		, 'method' => 'POST' , 'class'=>'parsley-style-1', 'id'=>'grupoForm', 'enctype' => 'multipart/form-data' ]) !!}
			...
			<div class="modal-header">
				<h6 class="modal-title">Matriz de Grupo Postal</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
			</div>
